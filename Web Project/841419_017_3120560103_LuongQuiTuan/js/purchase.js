...
function showPurchase() {
    ...
    function itemList() {
        ...
        var purchaseItems = document.getElementsByClassName('purchase-items')[0]
        var itemPurchased = `
                    <span class="purchase-item purchase-header purchase-column">SẢN PHẨM</span>
                    <span class="purchase-price purchase-header purchase-column">GIÁ</span>
                    <span class="purchase-quantity purchase-header purchase-column">SỐ LƯỢNG</span>
            `
        purchaseRow.innerHTML = itemPurchased
        purchaseItems.append(purchaseRow)
    }
