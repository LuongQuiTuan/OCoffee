...
function home() {
    var s = '<div id="titleproduct">Sản phẩm HOT nhất của chúng tôi</div>' +
        '<div id="boxproduct">' +
        '<div class="product">' +
        ...
        '<div id="titleblog">Những chia sẻ</div>' +
        '<div id="boxblog">' +
        '<div class="blog">' +
        '<div class="img-product">' +
        ...
        '<div id="titlestore">Các chi nhánh:</div>' +
        '<div id="boxstore">' +
        '<div class="store" id="store1">' +
        '<div class="img-product">' +
        '<img src="img/img1.png" alt="store1">' +
        '</div>' +
        ...
        '<div class="img-product">' +
        '<img src="img/img2.png" alt="store2">' +
        '</div>' +
        '<div class="hotline">HOTLINE: 0937.693.101</div>' +
        '<div class="name" style="margin-bottom: 2%;">' +
        '<p>Thành phố Hồ Chí Minh</p>' +
...
function contact() {
    var s;
    s = '<h4 class="contact-place-tile">Các chi nhánh</h4>' +
        ...
        '</div>' +
        '</div>' +
        '<h2 class="contact-tile">LIÊN HỆ VỚI CHÚNG TÔI</h2>' +
        '<!-- -----------------------contact form---------------------- -->' +
        '<div class="contact-form" style="overflow: hidden;">' +
        '<form>' +
        '<p>CONTACT FORM</p>' +
        '<div id="contact-text">' +
        '<label>Họ và tên</label><span id="requiredName">* Required</span><input type="text" value="" id="textName" placeholder="peter parker">' +
        '<label>Email</label><span id="requiredEmail">* Required</span><input type="email" value="" id="textEmail" placeholder="customer@gmail.com">' +
        '<label>Lời nhắn</label><textarea placeholder="Ask about us"></textarea>' +
        '<div id="button">' +
        '<button type="button" class="btn" onclick="checkInput()">Gửi</button>' +
        '</div>' +
...
function blog() {
    var s =
        ...
        // '<h2 class="blog-tile">Những chia sẻ</h2>' +
        '<!-- ------------------------FEATURED POSTS------------------- -->' +
        ...
        '<hr>' +
        '<h2>OurCoffee.</h2>' +
        '<p>OurCoffee is the most loved home base for espresso and discussions. Famously known as OurCoffee, we' +
